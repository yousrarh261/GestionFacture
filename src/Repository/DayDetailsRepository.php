 ...
 */
class DayDetailsRepository extends ServiceEntityRepository
{
...
//    /**
//     * @return DayDetails[] Returns an array of DayDetails objects
//     */
...
//    public function findOneBySomeField($value): ?DayDetails
//    {
//        return $this->createQueryBuilder('d')
//            ->andWhere('d.exampleField = :val')
//            ->setParameter('val', $value)
