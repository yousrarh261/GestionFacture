...
/**
* @Route("/user/cra/new", name="cra_new")
*/
public function create(Request $request): Response
{
   ...
   if ($form->isSubmitted() && $form->isValid()) {
    ...
    $entityManager->flush();
        ...
        $response = $this->forward('App\Controller\User\CraController::createDays', [
            'formData' => $formData,
        ]);
   ...
   return $this->render('user/cra/create.html.twig', [
...
/**
 * @Route("/user/edit/days", name="edit_days")
 */
public function createDays(Request $request)
{
    ...
    $entityManager->flush();
    return $this->redirectToRoute('user_download_receipt');   
}
/**
 * @Route("/cra", name="cra")
 */
public function index(Request $request, PaginatorInterface $paginator): Response
{
   ...
   /**
 * @Route("/user/download_receipt", name="download_receipt")
 */
...
/**
  ...
  */
  public function editCra(Request $request)
  {
    ...
    return $this->render('User/client/editCra.html.twig', [
        'form' => $form->createView(),
    ]);
  }

/**
* @Route("/user/cra/show", name="cra_show")
*/
...
/**
* @Route("/user/cra/showEditDays{id}", name="cra_showEditDays")
*/
...
public function showEditDays(Request $request, $id): Response
{
    ...
    dump($codeProjets);
    return $this->render('User/cra/edit.html.twig', [
        'cra' => $cra,
...
/**
* @Route("/user/cra/UpdateDays", name="cra_UpdateDays")
*/
